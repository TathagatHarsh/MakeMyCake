    ...
    <div className="flex h-full w-full items-center justify-center" role="status" aria-live="polite">
      <div className="flex flex-col items-center gap-4">
        <div className="relative h-24 w-32">
          <div className="absolute bottom-0 left-1/2 h-3 w-32 -translate-x-1/2 rounded-full bg-slab-deep" />
          <div className="absolute bottom-2 left-1/2 h-14 w-24 -translate-x-1/2 animate-pulse rounded-[10px] bg-slab-deep" />
          <div className="absolute bottom-14 left-1/2 h-8 w-16 -translate-x-1/2 animate-pulse rounded-[8px] bg-slab-deep" />
        </div>
